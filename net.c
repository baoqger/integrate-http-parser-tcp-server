...
int get_listener_socket(char *port) 
{
    ...
    for(p = servinfo; p != NULL; p = p->ai_next) {
        ...
        // SO_REUSEADDR prevents the "address alreay in usr" errors
        ...
        // see if we can bind this socket to this local IP address. This asscociates
        // the file descriptor(the socket descriptor) that 
